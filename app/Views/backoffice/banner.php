...
<section id="main" class="uk-section uk-section-small" hidden>
    <div class="uk-container uk-container-expand">
        ...
        <div class="uk-child-width-auto uk-flex-between" uk-grid>
            <div>
                <h1 class="uk-h3 uk-heading-bullet uk-margin-remove">Banner</h1>
            </div>
            <div>
                <a class="uk-button uk-button-third uk-border-rounded" href="#new-photo" uk-toggle>Tambah Banner</a>
            </div>
        </div>
        <!-- Pagination Top -->
        <div class="uk-flex uk-flex-right uk-margin">
            <?= $pager->links('banners', 'uikit_full') ?>
        </div>
        <!-- Banner Grid -->
        <div id="banner-container" class="uk-child-width-1-2 uk-child-width-1-4@m uk-grid-small" uk-grid>
            <?php foreach ($banners as $banner) { ?>
                <div>
                    <div class="uk-width-1-1 uk-card uk-card-default uk-card-hover uk-card-body uk-inline">
                        <div uk-lightbox>
                            <a class="uk-height-medium uk-flex uk-flex-middle uk-flex-center" href="/images/banner/<?=$banner['image']?>">
                                <img src="/images/banner/<?=$banner['image']?>" style="max-height:100%; max-width:100%" />
                            </a>
                        </div>
                        <div class="uk-position-medium uk-position-top-right">
                            <form action="/office/banner/delete" method="post">
                                <?= csrf_field() ?>
        ...
        <div id="new-photo" class="uk-flex-top" uk-modal="bg-close:false;">
            <div class="uk-modal-dialog uk-margin-auto-vertical">
                <button class="uk-modal-close-outside uk-icon-button uk-button-primary" type="button" uk-close></button>
                <div class="uk-modal-body">
                    <div class="new-upload uk-placeholder uk-text-center">
                        ...
                        <br/>
                        <span>Maks 1mb/file || <span class="uk-text-primary">Ratio 3:1</span></span>
                    </div>
        ...
        <script>
            ...
            UIkit.upload('.new-upload', {
                ...
                complete: function () {
                    ...
                    var imagecontainer = document.getElementById("banner-container");
                    ...
                    imagelink.setAttribute('href', '/images/banner/'+filename);

                    var image = document.createElement('img');
                    image.setAttribute('src', '/images/banner/'+filename);
                    ...
                    deleteform.setAttribute('action', '/office/banner/delete');
